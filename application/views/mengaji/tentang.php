...
<head>
    ...
    <link rel="stylesheet" href="styletentang.css" type="text/css">
    <!--CSS Custom-->
...
<link rel="stylesheet" href="<?= base_url('assets/') ?>css/styletentang.css" type="text/css">
<style>
    body {
...
<body>
    ...
    <main class="container-fluid px-4 p-3 mt-5 tentang1" id="konten">
        <div>
            <h3><b>Tentang</b></h3>
            <p class="tentang" style="text-align: justify;">Belajar Mengaji merupakan salah satu website yang dibuat untuk memenuhi <br /> tugas PBL <i>(Project Based Learning)</i> yang bertujuan sebagai wadah pembelajaran <br /> bagi anak-anak yang baru belajar mengaji </p>
        </div>
        ...
        <div class="bagian mt-50">
            ...
            <div class="kontak">
                ...
                <p><i class="fa-regular fa-envelope"></i> mariberamaimengaji@gmail.com</p>
                <p><i class="fa-solid fa-phone"></i> 0895-4105-97287</p>
            </div>
        </div>
    </main>
